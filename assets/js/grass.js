...
(function() {
  ...
  Grass.prototype= {
    ...
    alto_hierba: 0.3,    // grass height
    maxAngle:    40,    // maximum grass rotation angle (wind movement)
    angle:       30,    // construction angle. thus, every grass is different to others
    coords:      null,  // quadric bezier curves coordinates
    color:       null,  // grass color. modified by ambient component.
    offset_control_point:   20,    // grass base width. greater values, wider at the basement.
